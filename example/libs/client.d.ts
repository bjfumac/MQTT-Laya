declare module mqtt{
  ...
  type ClientSubscribeCallback = (err: Error, granted: ISubscriptionGrant[]) => void
  type OnMessageCallback = (topic: string, payload: Buffer, packet: Packet) => void
  type OnPacketCallback = (packet: Packet) => void
  type OnErrorCallback = (error: Error) => void
  type PacketCallback = (error?: Error, packet?: Packet) => any
  type CloseCallback = () => void

  interface IStream extends events.EventEmitter {
    pipe (to: any): any
    destroy (): any
    end (): any
  }
